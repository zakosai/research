...
class Dataset(object):
    ...
    def create_user_info(self, folder):
        ...
        self.user_info_train[1:8] = float(self.user_info_train[1:8])/sum(self.user_info_train[1:8])
        self.user_info_train[8:] = float(self.user_info_train[8:])/sum(self.user_info_train[8:])
        ...
        self.user_info_test[1:8] = float(self.user_info_test[1:8])/sum(self.user_info_test[1:8])
        self.user_info_test[8:] = float(self.user_info_test[8:])/sum(self.user_info_test[8:])
