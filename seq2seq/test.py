...
def main():
	...
	output_file = os.path.join(args.dataset, "models/result_%d.txt" % args.r_t)
	...
	if args.number_of_batches == "*" and args.method != "UKNN" and args.method != "MM" and args.method != "POP":
		...
		print_results(evaluator, args.metrics.split(','), file=output_file, print_full_rank_comparison=args.save_rank)
