...
pred = model.predict_all()
recalls_1 = model.predict(pred, data['train_users'], data['test_users'], 300)
...
plt.plot(np.arange(50, 300, 50), recalls_1, '-r', label="img-extend")
# plt.plot(np.arange(5, 40, 5), recalls_2, '-g', label="zdim=500")

plt.legend(loc='upper left')
plt.savefig("result/cf-vae-zdim_300.png")