...
model = vanilla_vae(input_dim=8000, encoding_dims=[200], z_dim=zdim, decoding_dims=[200, 8000], loss='cross_entropy', ckpt_folder=ckpt)
...
model.fit(train_X, epochs=3000,learning_rate=0.001, batch_size=500, print_size=50, train=True, scope="text")
