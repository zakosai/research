...
def handwriting_resnet_v2_generator(resnet_size, num_classes, data_format=None):
  ...
  def model(inputs, is_training):
    ...
    inputs = block_layer(
        inputs=inputs, filters=512, block_fn=building_block, blocks=num_blocks,
        strides=2, is_training=is_training, name='block_layer4',
        data_format=data_format)

    inputs = block_layer(
        inputs=inputs, filters=512, block_fn=building_block, blocks=num_blocks,
        strides=2, is_training=is_training, name='block_layer5',
        data_format=data_format)
