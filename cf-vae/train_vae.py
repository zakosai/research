...
# data = np.load(os.path.join(dir, "user_info_1.npy"))
...
model = vanilla_vae(input_dim=8000, encoding_dims=[200, 100], z_dim=zdim, decoding_dims=[100, 200, 800], loss='cross_entropy', ckpt_folder=ckpt)
