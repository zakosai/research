...
if args.type == "text":
    model = vanilla_vae(input_dim=8000, encoding_dims=[1000, 500], z_dim=zdim, decoding_dims=[500, 1000,8000], loss='cross_entropy', ckpt_folder=ckpt)
# As there will be an additional layer from 100 to 50 in the encoder. in decoder, we also take this layer
    ...
    model = vanilla_vae(input_dim=args.user_dim, encoding_dims=[400], z_dim=zdim, decoding_dims=[400,args.user_dim], loss='cross_entropy', ckpt_folder=ckpt)
    print('fitting data starts...')
