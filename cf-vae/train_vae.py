...
# data = variables['X']
variables = load_npz(os.path.join(dir, "mult_nor-small.npz"))
...
model = vanilla_vae(input_dim=8000, encoding_dims=[2000, 1000], z_dim=zdim, decoding_dims=[1000, 2000, 8000], loss='cross_entropy', ckpt_folder=ckpt)
