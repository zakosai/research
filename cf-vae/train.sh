...
do
    ...
    do
        ...
        python wae.py --ckpt_folder=$f/80 --data_dir=data2/$f/ --zdim=100 --data_type=$r --type=text
        python train_cf_wae.py --model=0 --ckpt_folder=$f/$r --data_dir=data2/$f/ --iter=50 --data_type=$r --user_no=$user_no --item_no=$item_no --gridsearch=1 --zdim=100
        ...
        python train_cf_dae.py --model=0 --ckpt_folder=$f/$r --data_dir=data2/$f/ --iter=50 --data_type=$r \
        --user_no=$user_no --item_no=$item_no --gridsearch=1 --zdim=100
