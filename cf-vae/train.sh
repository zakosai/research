...
do
    ...
    do
        ...
        python wae.py --ckpt_folder=$f/$r_wae --data_dir=data2/$f/ --zdim=100 --data_type=$r --user_dim=$dim --type=text
        python train_cf_wae.py --model=0 --ckpt_folder=$f/$r_wae --data_dir=data2/$f/ --iter=50 --data_type=$r --user_no=$user_no --item_no=$item_no --gridsearch=1 --zdim=100
...
python train_cvae_user.py --model=0 --ckpt_folder=Tool/8_att --data_dir=data2/Tool/ --iter=50 --zdim=50 --gridsearch=1 --data_type=8  --user_no=2118 --item_no=7780 --user_dim=830
python train_vae.py --ckpt_folder=Tool/1_att --data_dir=data2/Tool/ --zdim=100 --data_type=1
python train_vae.py --ckpt_folder=Tool/1_att --data_dir=data2/Tool/ --zdim=100 --data_type=1 --user_dim=830 --type=user
python train_cvae_user.py --model=0 --ckpt_folder=Tool/1_att --data_dir=data2/Tool/ --iter=50 --zdim=50 --gridsearch=1 --data_type=1 --user_no=2118 --item_no=7780 --user_dim=830
