...
python train_cave.py --model=0 --ckpt_folder=citeu/z2_50 --data_dir=data/citeulike-a/ --iter=200 --zdim=50
mkdir -p citeut/z2_50
python train_ave.py --ckpt_folder=citeut/z2_50 --data_dir=data/citeulike-t/
python train_cave.py --model=0 --ckpt_folder=citeut/z2_50 --data_dir=data/citeulike-t/ --iter=200 --zdim=50
git pull origin resnet
mkdir citeu/z3_50

python train_ave.py --ckpt_folder=citeu/z3_50 --data_dir=data/citeulike-a/
python train_cave.py --model=0 --ckpt_folder=citeu/z3_50 --data_dir=data/citeulike-a/ --iter=200 --zdim=50
#mkdir pre2/z6_100
