...
do
    ...
    python train_cvae_extend.py --model=0 --ckpt_folder=grocery/z$i_m --data_dir=data/amazon2/ --iter=15 --zdim=$i
    #python train_img_vae.py --ckpt_folder=grocery/z$i --data_dir=data/amazon2/ --zdim=$i
    python train_cvae_extend.py --model=1 --ckpt_folder=grocery/z$i_m --data_dir=data/amazon2/ --iter=15 --zdim=$i
done
