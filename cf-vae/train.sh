...
python train_cvae_extend.py --model=0 --ckpt_folder=grocery/z4_50 --data_dir=data/amazon2/ --iter=70 --zdim=50
python train_cvae_extend.py --model=1 --ckpt_folder=grocery/z4_50 --data_dir=data/amazon2/ --iter=70 --zdim=50

python train_cvae_extend.py --model=0 --ckpt_folder=pre2/z4_50 --data_dir=data/movie/ --iter=70 --zdim=50
python train_cvae_extend.py --model=6 --ckpt_folder=pre2/z4_50 --data_dir=data/movie/ --iter=70 --zdim=50
python train_cvae_extend.py --model=1 --ckpt_folder=pre2/z4_50 --data_dir=data/movie/ --iter=70 --zdim=50
