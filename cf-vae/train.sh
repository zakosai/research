python train_vae.py --ckpt_folder=kitchen/user8_n --data_dir=data/kitchen/ --zdim=50
#python train_img_vae.py --ckpt_folder=sport/vae --data_dir=data/sport/ --zdim=50

python train_cvae_user.py --model=0 --ckpt_folder=kitchen/user8_n --data_dir=data/kitchen/ --iter=50 --zdim=50
