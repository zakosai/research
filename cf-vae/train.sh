...
python train_cvae_extend.py --model=0 --ckpt_folder=pre2/cv --data_dir=data/movie/ --iter=15
python train_cvae_extend.py --model=1 --ckpt_folder=pre2/cv --data_dir=data/movie/ --iter=15
