...
python train_cvae_extend.py --model=1 --ckpt_folder=sport/vae2 --data_dir=data/sport/ --iter=50 --zdim=50

python train_cvae_extend.py --model=2 --ckpt_folder=sport/vae2 --data_dir=data/sport/ --iter=50 --zdim=50
