...
python train_cave.py --model=0 --ckpt_folder=citeu/z3_50 --data_dir=data/citeulike-a/ --iter=200 --zdim=50 --type=0

python train_cave.py --model=0 --ckpt_folder=citeu/z3_50 --data_dir=data/citeulike-a/ --iter=15 --zdim=50 --type=1
