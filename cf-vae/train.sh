...
python train_cvae_extend.py --model=0 --ckpt_folder=sport/user_sparse --data_dir=data/sport/ --iter=50 --zdim=50 --gridsearch=1

python train_cvae_user.py --model=0 --ckpt_folder=sport/user_sparse --data_dir=data/sport/ --iter=50 --zdim=50 --gridsearch=1
...
python train_cf_dae.py --model=0 --ckpt_folder=sport/dae_sparse --data_dir=data/sport/ --iter=50
