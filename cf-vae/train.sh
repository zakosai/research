...
#python train_cdae_user.py --model=0 --ckpt_folder=Outdoor/20 --data_dir=data/Outdoor/ --iter=50 --zdim=50  --data_type=20 --user_dim=979 --user_no=3205 --item_no=11560

#python train_dae.py --ckpt_folder=Outdoor/20 --data_dir=data/Outdoor/ --zdim=50 --data_type=20 --user_dim=979