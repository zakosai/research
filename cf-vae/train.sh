folders='Toy'
rate='1 8 80'
python train_dae.py --ckpt_folder=sport/1nn --data_dir=data/sport/ --zdim=50 --data_type=1 --user_dim=3883
python train_vae.py --ckpt_folder=sport/1nn --data_dir=data/sport/ --zdim=50 --data_type=1 --user_dim=3883
...
#
python train_cvae_user.py --model=0 --ckpt_folder=sport/1nn --data_dir=data/sport/ --iter=50 --zdim=50 --gridsearch=1 --data_type=1 --user_dim=3883 --user_no=5584 --item_no=13790
python train_cdae_user.py --model=0 --ckpt_folder=sport/1nn --data_dir=data/sport/ --iter=50 --zdim=50 --gridsearch=1 --data_type=1 --user_dim=3883 --user_no=5584 --item_no=13790
