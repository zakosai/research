...
item_no=7780
        ...
        #python train_dae.py --ckpt_folder=$f/0_layer --data_dir=data2/$f/ --zdim=50 --data_type=$r --user_dim=$dim --type=text

        #python train_cf_dae.py --model=0 --ckpt_folder=$f/0_layer --data_dir=data2/$f/ --iter=50 --data_type=$r --user_no=$user_no --item_no=$item_no --gridsearch=1 --zdim=50
        python train_cvae_user.py --model=0 --ckpt_folder=$f/0_layer --data_dir=data2/$f/ --iter=50 --zdim=50 --gridsearch=1 --data_type=$r --user_dim=$dim --user_no=$user_no --item_no=$item_no
        #python train_cvae_extend.py --model=0 --ckpt_folder=$f/0_layer --data_dir=data2/$f/ --iter=50 --zdim=50 --gridsearch=1 --data_type=$r --user_no=$user_no --item_no=$item_no
