...
python train_cf_dae.py --model=1 --ckpt_folder=grocery2/dae_im --data_dir=data/amazon2/ --iter=100 --zdim=50

#python train_dae.py --ckpt_folder=grocery2/dae --data_dir=data/amazon2/ --zdim=50
python train_cf_dae.py --model=0 --ckpt_folder=grocery2/dae --data_dir=data/amazon2/ --iter=100 --zdim=50
