...
def load_cvae_data():
  ...
  data["train_users"] = load_rating(data_dir + "cf-train-1-user-small.dat")
  data["train_items"] = load_rating(data_dir + "cf-train-1-items-small.dat")
  data["test_users"] = load_rating(data_dir + "cf-test-1-user-small.dat")
...
num_factors = 50
model = cf_vae_extend(num_users=5282, num_items=11414, num_factors=num_factors, params=params,
...
model.save_model("pre_model/sub/cf_vae_extend_total.mat")
