...
from cdae_user import cf_vae_extend, params
...
if gs == 1:
    ...
    model.save_model(os.path.join(ckpt,"cdae_user_%d.mat"%(model_type)))
    #model.load_model(os.path.join(ckpt, "cdae_user_0.mat"))
