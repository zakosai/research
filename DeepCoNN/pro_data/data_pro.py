...
import os
import pickle
tf.app.flags.DEFINE_string("valid_data","../data/music/music_valid.csv", " Data for validation")
tf.app.flags.DEFINE_string("test_data", "../data/music/music_test.csv", "Data for testing")
tf.app.flags.DEFINE_string("train_data", "../data/music/music_train.csv", "Data for training")
tf.app.flags.DEFINE_string("user_review", "../data/music/user_review", "User's reviews")
tf.app.flags.DEFINE_string("item_review", "../data/music/item_review", "Item's reviews")
