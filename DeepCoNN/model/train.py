...
tf.app.flags.DEFINE_string("para_data", "../data/music/music.para", "Data parameters")
tf.app.flags.DEFINE_string("train_data", "../data/music/music.train", "Data for training")

# ==================================================

# Model Hyperparameters
#tf.app.flags.DEFINE_string("word2vec", "./data/rt-polaritydata/google.bin", "Word2vec file with pre-trained embeddings (default: None)")
tf.app.flags.DEFINE_integer("embedding_dim", 300, "Dimensionality of character embedding ")
...
tf.app.flags.DEFINE_float("l2_reg_lambda", 0.0, "L2 regularizaion lambda")
tf.app.flags.DEFINE_float("l2_reg_V", 0, "L2 regularizaion V")
# Training parameters
...
tf.app.flags.DEFINE_integer("checkpoint_every", 100, "Save model after this many steps ")
# Misc Parameters
        ...
        with sess.as_default():
            ...
            for epoch in range(40):
                ...
                print ("loss_valid {:g}, rmse_valid {:g}, mae_valid {:g}".format(loss_s / test_length,
                                                                                 ...
                                                                                 mae_s / test_length))
                saver.save(sess,'logs/VDCNN/rs-17',
                           global_step=epoch)
