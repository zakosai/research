...
class Translation:
    ...
    def unet(self, x, encode_dim, decode_dim, scope):
        x_ = x
    ...
    def build_model(self):
        ...
        self.x_recon = self.unet(x, self.encode_dim, self.decode_dim, "CF")
...
def main(args):
    ...
    model = Translation(batch_size, dataset.no_item, dataset.user_size, dataset.item_size,
                        [1000, 500], [1000, dataset.no_item], 50, learning_rate=args.learning_rate)
    model.build_model()
