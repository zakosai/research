...
for f in $folders; do
    echo ${f}
    python multiVAE.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=1p --iter=200  >> /media/linh/DATA/research/new_cf/result3/multi_${f}_1.txt
    python triple_vae.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=1p  --iter=200  >> /media/linh/DATA/research/new_cf/result3/${f}_1.txt
