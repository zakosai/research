folders="Tool Outdoor Kitchen TV Beauty Toy Health Automotive Baby CD Clothing Garden Grocery Instrument Kindle Music Office Pet Phone Video"
for f in $folders; do
    echo ${f}
    ...
    python triple_vae.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=1p  --iter=200 --learning_rate=0.01 >> /media/linh/DATA/research/new_cf/result5/${f}_1.txt
