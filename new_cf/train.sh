...
folders="Tool Office Toy Outdoor Kindle Garden Beauty"
for f in $folders; do
    echo ${f}
...
#    python multiVAE_old.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=1p --iter=200 --learning_rate=0.001 >> /media/linh/DATA/research/new_cf/result8/multi_${f}_1.txt
    python multiVAE_old.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=8p --iter=200 --learning_rate=0.001 >> /media/linh/DATA/research/new_cf/result8/multi_${f}_1.txt
...
#    python new_model.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=8p --iter=200 --learning_rate=0.001 >> /media/linh/DATA/research/new_cf/result8/new_${f}_8.txt
    python triple_vae.py --data_dir=../cf-vae/data2/${f}/ --data_type=8p  --iter=400 --learning_rate=0.0001 >> /media/linh/DATA/research/new_cf/result8/${f}_1.txt
#    mkdir experiment/${f}/
