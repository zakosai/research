...
#folders="Outdoor Beauty CD Music Pet Phone Video"
for f in $folders; do
    echo ${f}
    python multiVAE.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=1p --iter=400 --learning_rate=0.001 >> /media/linh/DATA/research/new_cf/result9/multi_${f}_1.txt
...
#python triple_vae.py --data_dir=../cf-vae/data2/Phone/ --data_type=1p  --iter=200 --learning_rate=0.0001