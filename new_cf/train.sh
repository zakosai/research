...
#    python new_model.py --data_dir=/media/linh/DATA/research/cf-vae/data2/${f}/ --data_type=8p --iter=200 --learning_rate=0.001 >> /media/linh/DATA/research/new_cf/result7/new_${f}_8.txt
    python triple_vae.py --data_dir=../cf-vae/data2/${f}/ --data_type=8p  --iter=200 --learning_rate=0.0001 >> /media/linh/DATA/research/new_cf/result7/${f}_8.txt
#    mkdir experiment/${f}/
...
#python triple_vae.py --data_dir=../cf-vae/data2/Instrument/ --data_type=8p  --iter=200 --learning_rate=0.001