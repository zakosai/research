...
class Translation:
    ...
    def build_model(self):
        ...
        self.loss_user = tf.reduce_mean(tf.nn.l2_loss(self.user_info - user_recon)) + loss_kl_user + tf.losses.get_regularization_loss()
        ...
        self.loss_item = tf.reduce_mean(tf.nn.l2_loss(self.item_info - item_recon)) + loss_kl_item + tf.losses.get_regularization_loss()
